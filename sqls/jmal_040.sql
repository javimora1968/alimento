alter table dba.cs_total_encab_p_alissa  add
       costo_macros double precision null,
       costo_micros double precision null,
       costo_cif double precision null,
       costo_mob double precision null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.cs_total_encab_p_alissa');
