alter table dba.pp_bitacora_import_condor  add
       num_registros_condor numeric(18,0) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.pp_bitacora_import_condor');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'num_registros_condor', 8,
        'Num Registros Condor:', 0 ,
        'Num Registros Condor', 0,
       24 , '[General]',
       0 , 65 , 421 ,
        '', 'N',
