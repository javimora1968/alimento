alter table dba.cs_items_p_alissa  add
       ind_formulacion char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.cs_items_p_alissa');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'cs_items_p_alissa',
        object_id('dba.cs_items_p_alissa'),
        'dba',  'ind_formulacion', 19,
        'Ind Formulacion:', 0 ,
        'Ind Formulacion', 0,
       23 , '',
       0 , 65 , 69 ,
