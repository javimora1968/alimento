alter table dba.cs_costos_distribuir  add
       mano_obra_kilo numeric(18,3) null,
       indirectos_kilo numeric(18,3) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.cs_costos_distribuir');
