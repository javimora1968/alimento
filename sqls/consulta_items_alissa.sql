  SELECT dba.cs_items_p_alissa.id_empresa,   
   ...
   WHERE dba.cs_items_p_alissa.fecha=convert(datetime,'09/24/2002') AND
			dba.cs_items_p_alissa.ind_macro='S' AND
			dba.cs_items_p_alissa.cant_calculada > 0 AND
			dba.cs_items_p_alissa.id_ingrediente='MAMP075';			