alter table dba.cs_encab_p_alissa  add
       costo_m_obra numeric(18,3) null,
       costo_indirecto numeric(18,3) null,
       costo_total numeric(18,3) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.cs_encab_p_alissa');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'cs_encab_p_alissa',
        object_id('dba.cs_encab_p_alissa'),
        'dba',  'costo_m_obra', 17,
        'Costo M Obra:', 0 ,
        'Costo M Obra', 0,
       24 , '[General]',
