alter table dba.cs_consumo_alimento_x_formulas  add
       consumo_h_postura double precision null,
       consumo_m_postura double precision null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.cs_consumo_alimento_x_formulas');
